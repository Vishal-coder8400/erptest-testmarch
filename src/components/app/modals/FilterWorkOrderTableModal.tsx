...
import { WorkOrderTableData } from "../tables/production/WorkOrdersTable";

interface Props extends IModalProps {
  table: Table<WorkOrderTableData>;
}

const FilterWorkOrderTableModal: React.FC<Props> = ({
  isOpen,
  onClose,
  table,
}) => {
              ...
              <div className="w-full flex justify-end">
                <div className="w-full max-w-56">
                  <SelectFilter
                    items={processStage}
                    onValueChange={(value) => {
                      // TODO: change this iremStatus according to the table field in future
...
export default FilterWorkOrderTableModal;
