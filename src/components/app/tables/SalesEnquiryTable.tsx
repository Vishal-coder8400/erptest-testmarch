...
const SalesEnquiryTable: React.FC = () => {
  ...
  const columns: ColumnDef<Item>[] = [
      ...
      cell: ({ row }) => (
        <div className="font-normal min-w-32 flex items-center gap-4">
          ...
          <ArrowUpRight
            ...
            // href={`/sales-purchase/sales-enquiry-preview/${row.original.id}`}
            onClick={() =>
              navigate(
                `/sales-purchase/sales-enquiry-preview/${row.original.id}`
              )
            }
          />
        </div>
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="font-normal min-w-32 flex text-[#7047EB] items-center gap-4">
          {row.original.customerEnquiryNumber || "N/A"}
    ...
    {
      header: "Sales Enquiry Status",
      accessorKey: "salesEnquiryStatus",
      cell: ({ row }) => {
  ...
  const handleContinueBuyer = () => {
    navigate(`/sales-purchase/sales-enquiry`);
  };
                  ...
                  <TableRow>
                    ...
                    >
                      <div className="w-full flex flex-col gap-3 justify-center items-center">
                        ...
                        <h4 className="font-bold text-lg">No Sales Enquiry Added</h4>
                        <p className="max-w-xs text-[#121217] text-sm">
                          Please add a Sales Enquiry document to get started and manage
...
export default SalesEnquiryTable;
