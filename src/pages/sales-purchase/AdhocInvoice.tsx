...
import AdhocInvoiceTable from "@/components/app/tables/sales-purchase/AdhocInvoiceTable";

// TODO: add props here or fetch the data form the backend
const AdhocInvoice: React.FC = () => {
  const states = ["A", "a", "C"];
      ...
      <div className="grid md:grid-cols-3 gap-5">
        <div className="flex flex-col h-fit justify-between space-y-6">
          ...
          <div className="border-[1.5px]  rounded-lg border-neutral-200 text-sm">
            <div className="px-3 py-3 flex bg-[#F7F7F8] rounded-t-lg justify-between items-center gap-2">
              <h4 className="font-semibold">Buyers Details</h4>
            </div>
            <form className="space-y-2 px-4 py-3">
              <div className="space-y-2">
                <Label className={labelClasses} htmlFor="name">
                  Name <span className="text-[#F53D6B] -mr-2">*</span>
                </Label>
                <Input
              ...
              <div className="space-y-2">
                <Label className={labelClasses} htmlFor="address1">
                  Address 1 <span className="text-[#F53D6B] -mr-2">*</span>
                </Label>
                <Textarea
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-2">
                  <Label className={labelClasses} htmlFor="pin">
                    Pin{" "}
                  </Label>
                  <Select name="pin">
